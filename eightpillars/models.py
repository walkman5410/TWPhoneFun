...
class EightPillarData(models.Model):
    ...
    market_cap = MoneyField(max_digits=30, decimal_places=2, default_currency='USD', null=True)
    ...
    latest_revenue = MoneyField(max_digits=30, decimal_places=2, default_currency='USD', null=True)
    earliest_revenue = MoneyField(max_digits=30, decimal_places=2, default_currency='USD', null=True)
    is_revenue_growing = models.BooleanField(null=True)
    latest_net_income = MoneyField(max_digits=30, decimal_places=2, default_currency='USD', null=True)
    earliest_net_income = MoneyField(max_digits=30, decimal_places=2, default_currency='USD', null=True)
    is_net_income_growing = models.BooleanField(null=True)
    latest_shares_outstanding = models.FloatField(null=True)
    earliest_shares_outstanding = models.FloatField(null=True)
    ...
    latest_free_cash_flow = MoneyField(max_digits=30, decimal_places=2, default_currency='USD', null=True)
    earliest_free_cash_flow = MoneyField(max_digits=30, decimal_places=2, default_currency='USD', null=True)
    is_cash_flow_growing = models.BooleanField(null=True)
    average_cash_flow = MoneyField(max_digits=30, decimal_places=2, default_currency='USD', null=True)
    is_dividend_yield_affordable = models.BooleanField(null=True)
    cash_flow_value = MoneyField(max_digits=30, decimal_places=2, default_currency='USD', null=True)
